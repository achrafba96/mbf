...
#         fake_params['RMSprop_epsilon'] = best_epsilon
        ...
        path_to_best_results = path_to_google_drive_dir + name_result_with_params +\
                    best_name_result_pkl
        print('path_to_best_results for '+ args['algorithm'] + ' ' + path_to_best_results)
